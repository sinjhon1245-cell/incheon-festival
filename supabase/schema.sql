...
select * from (values
  ('am', '09:00 – 10:00', '1시간', '운영진 집결 및 부스 세팅',              '전시장 · 운영본부',      '운영',      1),
  ('am', '10:00 – 10:20', '20분',  '개막식 및 환영 인사',                   '메인무대',               '기조·강연', 2),
  ('am', '10:20 – 11:00', '40분',  '기조강연 「교실의 AI 전환, 무엇부터」',  '메인무대',               '기조·강연', 3),
  ('am', '11:00 – 16:00', '5시간', 'AI 체험 부스 운영 (40개 부스)',         '전시장 일대',            '체험·전시', 4),
  ('am', '11:00 – 16:00', '5시간', '학생 작품 전시 100선',                  '전시장',                 '체험·전시', 5),
  ('am', '11:30 – 12:10', '40분',  '특강 「데이터로 읽는 학습」',            '세미나실 A',             '기조·강연', 6),
  ('pm', '12:00 – 13:00', '1시간', '점심 및 부스 교대',                     '부스별 자율',            '운영',      7),
  ('pm', '13:00 – 13:40', '40분',  '로봇 퍼포먼스',                         '메인무대',               '무대 공연', 8),
  ('pm', '13:40 – 14:20', '40분',  '학생 공연 (밴드 · 댄스)',               '메인무대',               '무대 공연', 9),
  ('pm', '14:00 – 15:00', '1시간', '에듀테크 기업관 시연 세션',             '기업관(D존)',            '체험·전시', 10),
  ('pm', '15:00 – 15:40', '40분',  '특강 「AI와 함께 쓰는 글쓰기 수업」',    '세미나실 B',             '기조·강연', 11),
  ('pm', '16:00 – 16:40', '40분',  '폐막식 및 우수 작품 시상',              '메인무대',               '무대 공연', 12),
...
select * from (values
  ...
  (21, 'B', '재활용 재료로 만드는 로봇 팔',     '인천교육청 미래교육과',     8),
